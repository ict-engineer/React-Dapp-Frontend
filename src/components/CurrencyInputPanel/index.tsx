import { Currency, Pair } from '@uniswap/sdk/dist'
...
const CurrencySelect = styled.button<{ selected: boolean }>`
  ...
  :hover {
    background-color: ${({ selected, theme }) => (selected ? theme.bg2 : darken(0.05, '#FFFFFF'))};
  }
`
...
const StyledBalanceMax = styled.button`
  ...
  `};
`
const DefaultSelected = styled.div`
  display: inline-flex;
    ...
    <InputPanel id={id}>
      <Container hideInput={hideInput}>
        {!hideInput && (
          <LabelRow>
            <RowBetween>
              <TYPE.body color={'green'} fontWeight={500} fontSize={14}>
                {label}
              </TYPE.body>
              {account && (
                <TYPE.body
