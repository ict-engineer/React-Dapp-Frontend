...
var v,
  y = '0x5c7eea802f4588d3d0d84fa61a93156f9fbaeef4c4d0255c8a786f29bd0ec7bf',
  w = i.BigInt(1e3),
  T = i.BigInt(0),
  g = i.BigInt(1),
  k = i.BigInt(2),
...
function X(t, e) {
  i.greaterThanOrEqual(t, T) || u(!1), i.lessThanOrEqual(t, b[e]) || u(!1)
}
function K(t) {
  try {
          ...
          (lt = P(
            ...
            (((u = {})[s[0].address] = P(
              ...
              (((i = {})[s[1].address] = a.getCreate2Address(
                '0x5bDdC63f23c0386fb817959773c32b736744c899',
          ...
          if (i.equal(s, T)) a = e
            ...
            if (i.greaterThan(c, d)) {
              var p = i.multiply(e.raw, i.subtract(c, d)),
                ...
                f = i.divide(p, l)
              a = e.add(new dt(this.liquidityToken, f))
            } else a = e
          }
        } else a = e
  ...
  function t(t, e, n) {
    ...
    if (n === exports.TradeType.EXACT_INPUT) {
      ...
      for (var l = t.path.length - 1; l > 0; l--) {
        var f = t.pairs[l - 1].getInputAmount(a[l]),
          h = f[1]
        ;(a[l - 1] = f[0]), (s[l - 1] = h)
      }
    }
      ...
      for (var m = Tt(n, h), v = gt(r, h), y = 0; y < e.length; y++) {
        ...
        if (
          ...
          if (g.token.equals(v))
            ...
            t.bestTradeExactIn(k, g, r, { maxNumResults: p, maxHops: f - 1 }, [].concat(i, [w]), a, s)
          }
        }
      }
      return s
      ...
      for (var m = Tt(r, h), v = gt(n, h), y = 0; y < e.length; y++) {
        ...
        if (
          ...
          if (g.token.equals(v))
            ...
            var k = e.slice(0, y).concat(e.slice(y + 1, e.length))
            t.bestTradeExactOut(k, n, g, { maxNumResults: p, maxHops: f - 1 }, [w].concat(i), a, s)
          }
        }
      }
      return s
      ...
      (t.swapCallParameters = function(t, e) {
        ...
        switch (t.tradeType) {
          case exports.TradeType.EXACT_INPUT:
            n
              ? ((o = f ? 'swapExactETHForTokensSupportingFeeOnTransferTokens' : 'swapExactETHForTokens'),
                (i = [d, p, s, l]),
                (a = c))
              : r
              ? ((o = f ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH'),
                (i = [c, d, p, s, l]),
                (a = '0x0'))
              : ((o = f ? 'swapExactTokensForTokensSupportingFeeOnTransferTokens' : 'swapExactTokensForTokens'),
                (i = [c, d, p, s, l]),
                (a = '0x0'))
            break
          case exports.TradeType.EXACT_OUTPUT:
            f && u(!1),
              n
                ? ((o = 'swapETHForExactTokens'), (i = [d, p, s, l]), (a = c))
                : r
                ? ((o = 'swapTokensForExactETH'), (i = [d, c, p, s, l]), (a = '0x0'))
                : ((o = 'swapTokensForExactTokens'), (i = [d, c, p, s, l]), (a = '0x0'))
        }
    ...
    return (
      (t.fetchTokenData = function(t, e, n, r, o) {
        try {
          ...
          void 0 === n && (n = h.getDefaultProvider(f.getNetwork(t)))
          var s =
            'number' ==
          ...
          return Promise.resolve(
            s
              ? a(Ot[t][e])
              : Promise.resolve(
                  new l.Contract(e, Et, n).decimals().then(function(n) {
                    var r, o, i
                    return (
                      (Ot = P(
                        {},
      ...
      (t.fetchPairData = function(t, e, n) {
        try {
          void 0 === n && (n = h.getDefaultProvider(f.getNetwork(t.chainId))), t.chainId !== e.chainId && u(!1)
          ...
          return Promise.resolve(new l.Contract(r, m.abi, n).getReserves()).then(function(n) {
            ...
            return new ft(new dt(t, i[0]), new dt(e, i[1]))
          })
        } catch (t) {
          return Promise.reject(t)
        }
...
;(exports.JSBI = i),
  ...
  (exports.ETHER = $),
  (exports.FACTORY_ADDRESS = '0x5bDdC63f23c0386fb817959773c32b736744c899'),
  (exports.Fetcher = qt),
  (exports.Fraction = at),
